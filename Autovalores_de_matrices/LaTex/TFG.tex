...
El término \(\Delta_L\) se encarga de codificar la información entrante mediante el estímulo \(b(t)\) y almacenarla en la matriz de conexiones de forma \emph{permanente}, para ello se hace uso de la parte antisimétrica de \(W\) que queda inalterada mediante la homeostásis para producir un patrón en las conexiones similar al que se genera mediante el aprendizaje tipo STDP (\emph{spike time dependent plasticity}) \cite{susman2019}
\begin{align}
